...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Credentials Language Lines
    |--------------------------------------------------------------------------
    |
    | The following language lines are used in the first section of 
    | the event booking page and login or sign up page.
    |
    */
    ...
    'birthdate' => 'Birthday',
    'birthdate_hint' => 'Enter your birthdate...',
    'gender' => 'Gender',
    'password' => 'Password',
    ...
    'middle_name_hint' => 'Enter your middle name...',
    'last_name' => 'Last name',
    'last_name_hint' => 'Enter your last name...',
    'ext_name' => 'Ext. Name',
    'ext_name_hint' => 'E.g. Jr, III, ...',
    'email' => 'Email',
    ...
    'existing_account_log_in' => 'Existing Account? Log In',
    'register' => 'Register',
    'profile_picture' => 'Profile Picture',
    'choose_from_uploads' => 'Choose from Uploads',

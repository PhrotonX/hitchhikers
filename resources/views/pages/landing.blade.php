...
<head>
    ...
    <title>Hitchhike - Landing</title>
    
    @vite(['resources/css/app.css', 'resources/js/landingpage.js'])
...
<section class="section1">
    <div class="section1-content">
        ...
        <a href="{{ route('register') }}" class="section1-btn reveal scale-up">Get Started!</a>
    </div>
...
<section class="section6">
    <div class="container">
        ...
        <a href="{{ route('register') }}" class="cta-btn reveal">Join Hitchhike Today!</a>
    ...
    <div class="container">
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h3>Product</h3>
                <ul class="footer-links">
                    <li><a href="{{ url('/ride') }}">Book a Ride</a></li>
                    <li><a href="{{ url('/ride/create') }}">Offer a Ride</a></li>
